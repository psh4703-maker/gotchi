...
짧은 팝업 미션으로 먼저 협업해보고, 서로 확신이 생기면 정식 팀으로 합류하는 흐름을 만듭니다. 말이 아니라 실제 협업 기록으로 좋은 팀을 찾을 수 있도록 돕는 것이 목표입니다.
...
2. 미션 및 매칭
gotchi는 미션·팀 모집글 게시와 매칭 과정을 중개할 뿐, 게시된 내용의 진위나 완료 여부를 보증하지 않습니다. 금전 거래는 현재 이용자 간 직접 정산 방식으로 이루어지며, gotchi는 결제를 대행하지 않습니다.

3. 콘텐츠 책임
회원이 게시한 미션, 팀 모집글, 리뷰, 메시지 등의 내용에 대한 책임은 작성자 본인에게 있습니다.
...
- 이름, 역할: 프로필 표시
- 등록한 미션/팀 모집글, 지원 내역, 채팅 메시지, 리뷰: 서비스 이용 기록
